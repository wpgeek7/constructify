...
const Login = ({ onLoginSuccess, onGoogleSuccess, onSwitchToSignup, onForgotPassword }) => {
    ...
    <div className="login-container">
      ...
      <div className="login-right">
        <div className="login-form-container">
          <h1 className="form-title">Log in to Constructefy</h1>
          ...
          <form onSubmit={handleSubmit} className="login-form">
            ...
            <div className="form-options">
              ...
              <a href="#forgot" className="forgot-password" onClick={(e) => { e.preventDefault(); onForgotPassword && onForgotPassword(); }}>Forgot password?</a>
            </div>
          ...
          <div className="signup-link">
            Don't have an account? <a href="#signup" onClick={(e) => { e.preventDefault(); onSwitchToSignup && onSwitchToSignup(); }}>Create</a>
          </div>
        </div>
      </div>
    </div>
